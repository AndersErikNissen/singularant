<template>
  <div class="p-agents-agent">
    ...
    >
      ...
      />
      <div class="absolute top-0 left-5 right-5 h-full border-l border-r border-brand-950 z-10" />
    </section>
    <section class="px-5">
      <div class="grid grid-cols-2 gap-[1px] bg-brand-950 border-r border-l border-brand-950">
          ...
          <div class="overflow-hidden relative p-5">
            <Transition name="role-description">
              <div
                ...
                class="absolute top-0 left-0 size-full p-5 flex items-center text-brand-50 z-[1] bg-brand-500"
              >
